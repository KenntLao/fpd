				...
				<div class="row">					
					...
					<div class="col-xs-2">
						<div class="form-group mx-1">
							<select class="form-control select2 " id="lead_received_through" name="lead_received_through">
					...
					<div class="col-xs-3">
						<div class="form-group mx-1">
                  			<select class="form-control select2" id="other_remarks" name="other_remarks">
                  				<option selected="selected">Other Remarks</option>
                    			<?php 
                                    foreach($prospecting_other_remarks_arr as $key => $value) {
                                    echo '<option value="'.$key.'">'.renderLang($value).'</option>';
                                    }
                                ?>
                  			</select>
