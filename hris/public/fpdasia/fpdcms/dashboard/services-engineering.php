  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Engineering Services</h1>
          </div><!-- /.col -->
                  ...
                  <div class="form-group">
                    ...
                    <div class="input-group">
                      <div class="custom-file">
                        <input type="file" name="es_icon" accept="image/*" class="custom-file-input" id="exampleInputFile" required>
                        <label class="custom-file-label" for="exampleInputFile">Choose file</label>
                      </div>
                    </div>
                  </div>
                    <label for="exampleInputname">Title</label>
                    <input type="text"  name="es_name" class="form-control" id="exampleInputname" placeholder="Enter Title">
                  </div>
                  <div class="form-group">
                    <label>Description</label>
                    <textarea class="form-control" name="es_description" rows="3" placeholder="Enter ..."></textarea>
                  </div>
                </div>
                <!-- /.card-body -->
          ...
          <div class="col-sm-12">
            ...
            <div class="card">
              <div class="card-header bg-danger">
                <h3 class="card-title">Engineering Services</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body p-0">
                <table class="table table-bordered text-center my-auto">
                  ...
                  ?>
                    <tr>
                      <td><img src="../Assets/dashboard images/engineering services/<?php echo $es_icon; ?>"></td>
                      <td><p><?php echo $es_name; ?></p></td>
                      <td>
                        <p><?php echo $es_description; ?></p>
                      </td>
                    <?php
                    echo '<td>
                    <a class="btn btn-danger m-1" href=news-and-updates-delete-function.php?c_id=' . $fetch['es_id'] . '">Delete</a>';
                    echo '<a class="btn btn-primary m-1" href="engineering-edit.php?c_id=' . $fetch['es_id'] . '">Edit</a></td></tr>'; } ?>
                  </tbody>
                </table>
              </div>
              <!-- /.card-body -->
