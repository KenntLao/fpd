...
<div class="col-md-10">
  ...
  <button type="submit" class="btn btn-danger px-5" name="submit_position" value="Upload">Add Position</button>
    ...
    ?><tr>
          <td><img src="../admin/careers/job-icon/<?php echo $job_icon; ?>" width="70px"></td>
            ...
            <td><a href="edit-position.php?job_id=<?php echo $job_id; ?>" class="btn btn-primary">Edit</a><br>
              ...
              <td><a href="enabled.php?job_id=<?php echo $job_id;?>"><img src="../admin/careers/job-icon/<?php if ($enabled == 'enabled') { echo 'enabled'; } else { echo 'disabled';}?>.png" width='80%' /></a>
    </td>    </tr>
