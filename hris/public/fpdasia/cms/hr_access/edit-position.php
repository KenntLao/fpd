...
<div class="wrapper">
 ...
 <div class="form-group col-md-10">
  <img style="margin-left: 20px;margin-right: 20px;" src="../admin/careers/job-icon/<?php echo $fetch['job_icon'];?>" accept="image/*" width="50px"><br>
   ...
   <div class="form-group col-md-10">
  <img style="margin-left: 20px;margin-right: 20px;" src="../admin/careers/job-image/<?php echo $fetch['job_image'];?>" accept="image/*" width="50px"> <br><br>
