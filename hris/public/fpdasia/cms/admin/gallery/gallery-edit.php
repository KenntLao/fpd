...
<div class="wrapper">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       <li><a href="../news-and-updates/news-and-updates.php"><i class="fa fa-newspaper-o"></i> <span>News and Updates</span></a></li>  
        <li class="treeview">
          <a href="#">
            <i class="fa fa-newspaper-o"></i> <span>Careers</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
  ...
  <section class="content">
    ...
    if (isset($_GET['gallery_id'])) {
         $views = $_GET['gallery_id'];
          }

          $sql = "SELECT * FROM table_gallery WHERE gallery_id = '$views'";
    ...
    ?>
    <img src="<?php echo $gallery_image; ?>" width="20%">
     <a class="btn btn-success" href="thumbnail-edit.php?gallery_id=<?php echo $gallery_id; ?>">Edit Thumbnail</a>
    <h3>
      <?php echo $gallery_name; ?>
      <a class="btn btn-success" href="album-edit.php?gallery_id=<?php echo $gallery_id; ?>">Edit Name and Date</a>
    </h3>
    <p class="text-muted">
       <?php echo date('F, Y', strtotime($gallery_date)); ?>
    </p><br>
           <?php  }?>

<!--add image-->

        <form action="image-add.php?gallery_id=<?php echo $gallery_id; ?>" method="post" enctype="multipart/form-data">
          <div class="form-row">
            <div class="col-sm-6">
        <input type="file" name="images" class="form-control" required>
            </div>
            <div class="col-sm-6">
        <input type="submit" name="add_image" accept="image/*"  value="Add image" class="btn btn-primary">
            </div>
        </div>
      </form><br><br><br><br>
...
<div class="row">
    ...
    $view=0;
    if (isset($_GET['gallery_id'])) {
         $view = $_GET['gallery_id'];
          }

          $sql = "SELECT id ,images  FROM table_gallery_images WHERE image_deleted IS NULL and gallery_id=$view ORDER BY id DESC ";
    ...
    <div class="col-sm-4 " style="margin-bottom: 9px;">
      <img  src="<?php echo $images; ?>" width="50%" style="margin: 2px;"><br>
      <a class="btn btn-danger" href="image-delete.php?image_id=<?php echo $id; ?>&gallery_id=<?php echo $view; ?>">Delete Image</a>
    </div>
