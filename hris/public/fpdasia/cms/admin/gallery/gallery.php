...
<div class="wrapper">
 ...
 <form  action="gallery-upload-function.php" method="post" enctype="multipart/form-data" name="addroom">
 <div class="form-group col-md-4">
    <label class="text-left font-weight-bold">Thumbnail</label>
    <input type="file" name="gallery_image" accept="image/*" class="form-control bg-light">
  </div>

  <div class="form-group col-md-6">
    <label class="text-left font-weight-bold">Gallery Name</label>
    <input type="text" name="gallery_name" class="form-control bg-light">
  </div>

<div class="form-group col-md-10">
    <label class="text-left font-weight-bold">Multiple Image</label>
    <input type="file" name="gallery_images[]" accept="image/*" multiple="" class="form-control bg-light" placeholder="Images">
  </div>

  <div class="form-group col-md-10">
    <label class="text-left font-weight-bold">Date</label>
    <input type="month" name="gallery_date" class="form-control bg-light" placeholder="Date">
  </div>
  ...
  <section class="content">
    <div class="box box-default">
      ...
      $sql = "SELECT * FROM table_gallery WHERE album_deleted IS NULL and gallery_id ORDER BY gallery_id DESC ";
      $result = mysqli_query($con, $sql);
    ...
    ?><tr><td width="20%">
          <img src="<?php echo $gallery_image; ?>" width="50%" alt="..."></td>
          <td width="20%"><h4><?php echo $gallery_name; ?></h4>
          <small><?php echo date('F j, Y', strtotime($gallery_date)); ?></small></td>

    <?php
          echo '<td  width="20%"><a style="margin:4px;" class="btn btn-primary" href="gallery-edit.php?gallery_id=' . $fetch['gallery_id'] . '">View Album</a><br>';
          echo '<a style="margin:4px;" class="btn btn-danger" href="album-delete.php?gallery_id=' . $fetch['gallery_id'] . '">Delete Album</a></td></tr>';
              }
    ?>
    </table>
    </div>
