<?php
  ...
  $result = mysqli_query($con,"SELECT * FROM table_gallery WHERE gallery_id=$gall_id") or die(mysqli_error());
  $fetch=mysqli_fetch_assoc($result);
    if(isset($_POST['update_nt'])) {

        $gallery_name_new=$_POST['gallery_name'];
        $gallery_date_new=$_POST['gallery_date'];

         

    $sql=mysqli_query($con," UPDATE table_gallery SET gallery_name='$gallery_name_new', gallery_date='$gallery_date_new' WHERE gallery_id='$gall_id'");
...
<div class="wrapper">
 ...
 <div class="form-group">
  ...
  <div class="form-group col-md-10">
    <label class="text-left font-weight-bold">Update Event Name</label>
    <input type="text" name="gallery_name" value="<?=$fetch['gallery_name']?>" class="form-control bg-light">
  </div>

  <div class="form-group col-md-10">
    <label class="text-left font-weight-bold">Update Event Date</label>
    <input type="date" name="gallery_date" value="<?=$fetch['gallery_date']?>" class="form-control bg-light">
  </div>


  <div class="form-group col-md-10">
  <button type="submit" class="btn btn-danger px-5" name="update_nt" value="Update"><a href="events.php"></a>Update</button>
</div>
</form>
