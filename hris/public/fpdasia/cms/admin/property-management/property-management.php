...
<form action="pm-upload-function.php" method="post" enctype="multipart/form-data" style="margin-left: 3px;">
...
<h4><i class="icon fa fa-check"></i> Success!</h4>Position added.</div>
  ...
  <div class="form-group col-md-10">
    ...
    <input type="file" name="pm_image" class="form-control bg-light" placeholder="Image">
  </div>

  <div class="form-group col-md-10">
    <label class="text-left font-weight-bold">Properties Icon</label>
    <input type="file" name="pm_icon" class="form-control bg-light" placeholder="Image">
  </div>

  <div class="form-group col-md-10">
    <label class="text-left font-weight-bold">Properties Name GIF</label>
    <input type="file" name="pm_name_gif" class="form-control bg-light" placeholder="Image">
  </div>

    <div class="form-group col-md-10">
    <label class="text-left font-weight-bold">Properties Name</label>
    <input type="text" name="pm_name" class="form-control bg-light" >
  </div>

<div class="col-md-10">
    <label class="text-left font-weight-bold">Properties Details</label>
      <textarea type="text" name="pm_details" class="textarea" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
  </div>

  <div class="form-group col-md-10">
  <button type="submit" class="btn btn-danger px-5" name="submit_pm" value="Upload">Upload</button>
</div>
    ...
    ?><tr>
          <td><img src="pm-icon/<?php echo $pm_icon; ?>" width="70px"></td>
            <td><h4><?php echo $pm_name; ?></h4></td>
            <td><?php echo $pm_details; ?></td>
            <td><a href="edit-pm.php?pm_id=<?php echo $pm_id; ?>" class="btn btn-primary">Edit</a><br>
              <a href="delete-pm.php?pm_id=<?php echo $pm_id; ?>" class="btn btn-danger">Delete</a><br>
      </tr>
