...
if(!isset($_FILES['nu_image']['tmp_name'])) {
  echo "error";
	...
	$image_name= addslashes($_FILES['nu_image']['name']);
	 move_uploaded_file($_FILES["nu_image"]["tmp_name"],"../../admin/news-and-updates/news-and-updates/" . $_FILES["nu_image"]["name"]);
...
<div class="wrapper">
 ...
 <div class="form-group">
 	<img style="margin-left: 20px;margin-right: 20px;" src="../../admin/news-and-updates/news-and-updates/<?php echo $fetch['nu_image'];?>" accept="image/*" width="20%" required>
 	</div>
...
<div class="col-md-10">
  ...
  <div class="form-group col-md-10">
  <button type="submit" class="btn btn-danger px-5" name="update" >
