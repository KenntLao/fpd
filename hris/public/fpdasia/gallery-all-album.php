...
<h2 class="font-weight-bold text-center mt-4">
  <span><img src="gif/Gallery.gif" class="gif2" ></span>
</h2>
...
$sql = "SELECT * FROM table_gallery WHERE album_deleted IS NULL ORDER BY gallery_date DESC";
...
<!--View Less button-->
    <div class="my-4 ">  
      <a href="gallery.php?albums" class="btn btn-danger m-left">View Less Album</a>
    </div>
</div>
<br>
  ...
  <h3 class="text-center text-danger">Gallery Archive</h3>
