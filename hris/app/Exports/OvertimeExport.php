            ...
            if ( $this->employee_id == '0' ) {
                if ( $this->report == 1 ) {
                    ...
                    $overtimes = hris_overtime::groupBy('employee_id')->selectRaw(
                        ...
                        employee_id'
                    )->where('status', '1')->where('overtime_category_id', 3)->whereBetween('ot_date', [$this->date_from, $this->date_to])->get()
                    ]);
                } else {
                    return view('pages.time.overtime.table', [
                    'overtimes' => 
                ...
                $overtimes = hris_overtime::groupBy('employee_id')->selectRaw(
                    ...
                    sum(LGLSPL_ND1_2_ND2) as LGLSPL_ND1_2_ND2_SUM,
                    employee_id'
                )->where('status', '1')->where('overtime_category_id', 3)->where('employee_id', $this->employee_id)->whereBetween('ot_date', [$this->date_from, $this->date_to])->get()
                ]);
                } else {
                    return view('pages.time.overtime.table', [
                    'overtimes' => 
