...
<div class="card">
	<div class="card-header">
		...
		@if(in_array('employee-certification-add', $_SESSION['sys_permissions']))
			...
			<table class="table table-hover table-bordered table-striped table-condensed">
				<thead>
					<tr>
						...
						<th>start date</th>
						<th>completed on</th>
						@if(in_array('employee-certification-edit', $_SESSION['sys_permissions']) OR in_array('employee-certification-delete', $_SESSION['sys_permissions']))
						<th>actions</th>
						@endif
					</tr>
				</thead>
				<tbody>
					...
					<tr>
						...
						<td class="td-action">
							<div class="row no-gutters">
								@if(in_array('employee-certification-edit', $_SESSION['sys_permissions']))
								<div class="col-6">
								...
								@endif
								@if(in_array('employee-certification-delete', $_SESSION['sys_permissions']))
								<div class="col-6">
