...
<div class="card">
	<div class="card-header">
		<h3 class="card-title">Hr Document list</h3>
		@if(in_array('company-document-add', $_SESSION['sys_permissions']))
		<div class="card-tools">
			<a class="btn add-button btn-md" href="/hris/pages/documents/hrDocuments/create"><i class="fa fa-plus mr-1"></i> add document</a>
		</div>
		@endif
	</div>
	<div class="card-body">
		...
		<div class="table-responsive">
			<table class="table table-hover table-bordered table-striped table-condensed">
				...
				<tbody>
					...
					<tr>
						<td><a href="/hris/pages/documents/hrDocuments/download/{{$document->id}}">{{$document->document_name}}</a></td>
						<td class="td-action">
							<div class="row no-gutters">
								<div class="col-6">
									<!-- Button trigger modal -->
									<button class="btn btn-danger btn-sm delete-btn" type="button" data-toggle="modal" data-target="#modal-{{$document->id}}" data-name="{{$document->document_name}}"><i class="fa fa-trash"></i></button>
								</div>
							</div>
						</td>
					</tr>
