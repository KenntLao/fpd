...
<div class="card">
	<div class="card-header">
		...
		@if(in_array('course-add', $_SESSION['sys_permissions']))
			...
			<table class="table table-hover table-bordered table-striped table-condensed">
				...
				<tbody>
					...
					<tr>
						...
						<td class="td-action">
							<div class="row no-gutters">
								@if(in_array('course-edit', $_SESSION['sys_permissions']))
								<div class="col-6">
									<a class="btn btn-success btn-sm" href="/hris/pages/admin/training/courses/{{$course->id}}/edit"><i class="fa fa-edit"></i></a>
								</div>
								@endif
								@if(in_array('course-delete', $_SESSION['sys_permissions']))
								<div class="col-6">
									<!-- Button trigger modal -->
									<button class="btn btn-danger btn-sm delete-btn" type="button" data-toggle="modal" data-target="#modal-{{$course->id}}" data-name="{{$course->name}}"><i class="fa fa-trash"></i></button>
								</div>
								@endif
							</div>
						</td>
