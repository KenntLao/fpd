				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<button type="button" data-toggle="modal" data-target="#modal-{{$overtimeCategory->id}}"><i class="fa fa-trash"></i></button>
							<!-- Modal -->
							<div class="modal fade" id="modal-{{$overtimeCategory->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-{{$overtimeCategory->id}}" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<hr>
											<form action="/hris/pages/admin/overtime/overtimeCategories/delete/{{$overtimeCategory->id}}" method="post" id="form-{{$overtimeCategory->id}}">
												@csrf
												@method('DELETE')
										...
										<div class="modal-footer">
											<button class="btn btn-danger" type="submit" form="form-{{$overtimeCategory->id}}"><i class="fa fa-check"></i> Confirm Delete</button>
