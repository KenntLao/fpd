				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<button type="button" data-toggle="modal" data-target="#modal-{{$skill->id}}"><i class="fa fa-trash"></i></button>
							<!-- Modal -->
								...
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<hr>
											<form action="/hris/pages/admin/qualifications/skills/delete/{{$skill->id}}" method="post" id="form-{{$skill->id}}">
												@csrf
												@method('DELETE')
										...
										<div class="modal-footer">
											<button class="btn btn-danger" type="submit" form="form-{{$skill->id}}"><i class="fa fa-check"></i> Confirm Delete</button>
