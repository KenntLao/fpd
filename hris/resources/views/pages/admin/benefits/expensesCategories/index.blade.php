				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<button type="button" data-toggle="modal" data-target="#modal-{{$expensesCategory->id}}"><i class="fa fa-trash"></i></button>
							<!-- Modal -->
							<div class="modal fade" id="modal-{{$expensesCategory->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-{{$expensesCategory->id}}" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<hr>
											<form action="/hris/pages/admin/benefits/expensesCategories/delete/{{$expensesCategory->id}}" method="post" id="form-{{$expensesCategory->id}}">
												@csrf
												@method('DELETE')
										...
										<div class="modal-footer">
											<button class="btn btn-danger" type="submit" form="form-{{$expensesCategory->id}}"><i class="fa fa-check"></i> Confirm Delete</button>
