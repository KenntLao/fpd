...
<div class="card">
	...
	<div class="card-body">
		<form class="form-horizontal" method="post" action="/hris/pages/admin/benefits/paymentMethods" id="form">
			@include('pages.admin.benefits.paymentMethods.form')
		</form>
	</div>
	<div class="card-footer text-right">
		<a class="btn btn-default mr-1" href="/hris/pages/admin/benefits/paymentMethods/index"><i class="fa fa-arrow-left"></i> back</a>
		<button class="btn btn-success" type="submit" form="form"><i class="fa fa-upload mr-1"></i> save payment method</button>
	</div>
</div>
@stop
@section('css')
