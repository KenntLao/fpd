			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<button type="button" data-toggle="modal" data-target="#modal-{{$leaveType->id}}"><i class="fa fa-trash"></i></button>
						<!-- Modal -->
						<div class="modal fade" id="modal-{{$leaveType->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-{{$leaveType->id}}" aria-hidden="true">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<hr>
										<form action="/hris/pages/admin/leave/leaveTypes/delete/{{$leaveType->id}}" method="post" id="form-{{$leaveType->id}}">
											@csrf
											@method('DELETE')
									...
									<div class="modal-footer">
										<button class="btn btn-danger" type="submit" form="form-{{$leaveType->id}}"><i class="fa fa-check"></i> Confirm Delete</button>
