...
<div class="card">
	...
	<div class="card-body">
		<form class="form-horizontal" method="post" action="/hris/pages/admin/leave/leaveTypes/update/{{$leaveType->id}}" id="form">
			@method('PATCH')
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$('.color-box').css('background-color', '#'+$('#colorInput').val());
