...
@section('title', 'HRIS | Leave Settings - Leave Rules')
...
<div class="card">
	...
	<div class="card-body">
		<form class="form-horizontal" method="post" action="/hris/pages/admin/leave/leaveRules/update/{{$leaveRule->id}}" id="form">
			@method('PATCH')
