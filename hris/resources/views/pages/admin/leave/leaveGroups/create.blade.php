...
<div class="card">
	<div class="card-header">
		<h3 class="card-title">add leave group</h3>
	</div>
	<div class="card-body">
		<form class="form-horizontal" method="post" action="/hris/pages/admin/leave/leaveGroups" id="form">
			@include('pages.admin.leave.leaveGroups.form')
		</form>
	</div>
