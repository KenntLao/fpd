			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<button type="button" data-toggle="modal" data-target="#modal-{{$leaveGroup->id}}"><i class="fa fa-trash"></i></button>
						<!-- Modal -->
						<div class="modal fade" id="modal-{{$leaveGroup->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-{{$leaveGroup->id}}" aria-hidden="true">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<hr>
										<form action="/hris/pages/admin/leave/leaveGroups/delete/{{$leaveGroup->id}}" method="post" id="form-{{$leaveGroup->id}}">
											@csrf
											@method('DELETE')
									...
									<div class="modal-footer">
										<button class="btn btn-danger" type="submit" form="form-{{$leaveGroup->id}}"><i class="fa fa-check"></i> Confirm Delete</button>
