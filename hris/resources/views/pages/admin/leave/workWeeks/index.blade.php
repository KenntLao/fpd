			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<button type="button" data-toggle="modal" data-target="#modal-{{$workWeek->id}}"><i class="fa fa-trash"></i></button>
						<!-- Modal -->
						<div class="modal fade" id="modal-{{$workWeek->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-{{$workWeek->id}}" aria-hidden="true">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<hr>
										<form action="/hris/pages/admin/leave/workWeeks/delete/{{$workWeek->id}}" method="post" id="form-{{$workWeek->id}}">
											@csrf
											@method('DELETE')
									...
									<div class="modal-footer">
										<button class="btn btn-danger" type="submit" form="form-{{$workWeek->id}}"><i class="fa fa-check"></i> Confirm Delete</button>
