...
<div class="card">
	<div class="card-header">
		<h3 class="card-title">add leave period</h3>
	</div>
	<div class="card-body">
		<form class="form-horizontal" method="post" action="/hris/pages/admin/leave/leavePeriods" id="form">
			@csrf
			<div class="row">
				...
				<div class="col-12 col-md-6 col-xl-4">
					<div class="form-group">
						...
						<span class="badge badge-danger">Required</span>
						<input class="form-control required" type="date" name="start" required>
					</div>
				</div>
				<div class="col-12 col-md-6 col-xl-4">
					<div class="form-group">
						...
						<span class="badge badge-danger">Required</span>
						<input class="form-control required" type="date" name="end" required>
					</div>
				</div>
			</div>
		</form>
