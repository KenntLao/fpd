			...
			<tbody>
				...
				<tr>
					...
					<td>
						...
						<button type="button" data-toggle="modal" data-target="#modal-{{$leaveGroupEmployee->id}}"><i class="fa fa-trash"></i></button>
						<!-- Modal -->
						<div class="modal fade" id="modal-{{$leaveGroupEmployee->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-{{$leaveGroupEmployee->id}}" aria-hidden="true">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<hr>
										<form action="/hris/pages/admin/leave/leaveGroupEmployees/delete/{{$leaveGroupEmployee->id}}" method="post" id="form-{{$leaveGroupEmployee->id}}">
											@csrf
											@method('DELETE')
									...
									<div class="modal-footer">
										<button class="btn btn-danger" type="submit" form="form-{{$leaveGroupEmployee->id}}"><i class="fa fa-check"></i> Confirm Delete</button>
