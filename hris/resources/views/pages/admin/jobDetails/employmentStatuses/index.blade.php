...
<div class="card">
	<div class="card-header">
		...
		@if(in_array('employment-status', $_SESSION['sys_permissions']))
		<div class="card-tools">
			<a class="btn add-button btn-md" href="/hris/pages/admin/jobDetails/employmentStatuses/create"><i class="fa fa-plus mr-1"></i> add employment status</a>
		</div>
		@endif
	</div>
	<div class="card-body">
		...
		<table class="table table-hover table-bordered table-striped table-condensed">
			<thead>
				<tr>
					...
					<th>name</th>
					<th>description</th>
					@if(in_array('employment-status-edit', $_SESSION['sys_permissions']) OR in_array('employment-status-delete', $_SESSION['sys_permissions']))
					<th>actions</th>
					@endif
				</tr>
			</thead>
			<tbody>
				...
				<tr>
					...
					<td class="td-action">
						<div class="row no-gutters">
							@if(in_array('employment-status-edit', $_SESSION['sys_permissions']))
							<div class="col-6">
								<a class="btn btn-success btn-sm" href="/hris/pages/admin/jobDetails/employmentStatuses/{{$employmentStatus->id}}/edit"><i class="fa fa-edit"></i></a>
							</div>
							@endif
							@if(in_array('employment-status-delete', $_SESSION['sys_permissions']))
							<div class="col-6">
								<!-- Button trigger modal -->
								<button class="btn btn-danger btn-sm delete-btn" type="button" data-toggle="modal" data-target="#modal-{{$employmentStatus->id}}" data-name="{{$employmentStatus->name}}"><i class="fa fa-trash"></i></button>
							</div>
							@endif
						</div>
					</td>
