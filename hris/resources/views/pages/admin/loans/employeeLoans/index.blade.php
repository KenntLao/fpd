				...
				<tbody>
					...
					<tr>
						...
						<td class="td-action">
							<div class="row no-gutters">
								<div class="col-6">
									<a class="btn btn-success btn-sm" href="/hris/pages/admin/loans/employeeLoans/{{$employeeLoan->id}}/edit"><i class="fas fa-fw fa-edit"></i></a>
								</div>
								<div class="col-6">
									<!-- Button trigger modal -->
									<button class="btn btn-danger btn-sm delete-btn" type="button" data-toggle="modal" data-target="#modal-{{$employeeLoan->id}}" data-name="Employee Loan Id: {{$employeeLoan->id}}"><i class="fas fa-fw fa-trash"></i></button>
								</div>
							</div>
						</td>
					</tr>
