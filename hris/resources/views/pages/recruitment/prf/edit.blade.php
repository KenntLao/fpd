...
<div class="card">
	...
	<div class="card-body">
		<form class="form-horizontal" method="post" action="/hris/pages/recruitment/prf/update/{{$prf->id}}" enctype="multipart/form-data" id="form">
			@method('PATCH')
	...
	<div class="card-footer text-right">
		...
		<button class="btn btn-success" type="submit" form="form"><i class="fa fa-upload mr-1"></i> save prf</button>
	</div>
</div>
@stop
@section('css')
