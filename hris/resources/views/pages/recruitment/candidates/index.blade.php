				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<button type="button" data-toggle="modal" data-target="#modal-{{$candidate->id}}"><i class="fa fa-trash"></i></button>
							<!-- Modal -->
							<div class="modal fade" id="modal-{{$candidate->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-{{$candidate->id}}" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<hr>
											<form action="/hris/pages/recruitment/candidates/delete/{{$candidate->id}}" method="post" id="form-{{$candidate->id}}">
												@csrf
												@method('DELETE')
										...
										<div class="modal-footer">
											<button class="btn btn-danger" type="submit" form="form-{{$candidate->id}}"><i class="fa fa-check"></i> Confirm Delete</button>
