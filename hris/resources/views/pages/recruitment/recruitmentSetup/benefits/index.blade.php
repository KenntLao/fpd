...
<div class="card">
	<div class="card-header">
		...
		@if(in_array('benefit-add', $_SESSION['sys_permissions']))
			...
			<table class="table table-hover table-bordered table-striped table-condensed">
				<thead>
					<tr>
						<th>id</th>
						<th>name</th>
						@if(in_array('benefit-edit', $_SESSION['sys_permissions']) OR in_array('benefit-delete', $_SESSION['sys_permissions']))
						<th>action</th>
						@endif
					</tr>
				</thead>
				<tbody>
					...
					<tr>
						...
						<td class="td-action">
							<div class="row no-gutters">
								@if(in_array('benefit-edit', $_SESSION['sys_permissions']))
								<div class="col-6">
									<a class="btn btn-success btn-sm" href="/hris/pages/recruitment/recruitmentSetup/benefits/{{$benefit->id}}/edit"><i class="fa fa-edit"></i></a>
								</div>
								@endif
								@if(in_array('benefit-delete', $_SESSION['sys_permissions']))
								<div class="col-6">
									<!-- Button trigger modal -->
									<button class="btn btn-danger btn-sm delete-btn" type="button" data-toggle="modal" data-target="#modal-{{$benefit->id}}" data-name="{{$benefit->name}}"><i class="fa fa-trash"></i></button>
								</div>
								@endif
							</div>
						</td>
