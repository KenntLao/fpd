				...
				<tbody>
					...
					<tr>
						...
						<td>
							...
							<button type="button" data-toggle="modal" data-target="#modal-{{$experienceLevel->id}}"><i class="fa fa-trash"></i></button>
							<!-- Modal -->
							<div class="modal fade" id="modal-{{$experienceLevel->id}}" tabindex="-1" role="dialog" aria-labelledby="modal-{{$experienceLevel->id}}" aria-hidden="true">
								<div class="modal-dialog" role="document">
									<div class="modal-content">
										...
										<div class="modal-body">
											...
											<hr>
											<form action="/hris/pages/recruitment/recruitmentSetup/experienceLevels/delete/{{$experienceLevel->id}}" method="post" id="form-{{$experienceLevel->id}}">
												@csrf
												@method('DELETE')
										...
										<div class="modal-footer">
											<button class="btn btn-danger" type="submit" form="form-{{$experienceLevel->id}}"><i class="fa fa-check"></i> Confirm Delete</button>
