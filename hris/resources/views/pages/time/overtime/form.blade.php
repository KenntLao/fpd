...
<div class="row">
	<div class="col-12 col-md-4">
		<div class="form-group">
			...
			<div class="input">
				@if($id == $overtime->supervisor_id OR $_SESSION['sys_role_ids'] == ',1,')
	...
	<div class="col-12 col-md-6">
		<div class="form-group">
			...
			<div class="input">
				...
				<textarea class="form-control required" name="supervisor_remarks" required {{ $overtime->status == 'Approved' ? 'readonly' : '' ?? $overtime->status == 'Rejected' ? 'readonly' : '' }} >{{ old('supervisor_remarks') ?? $overtime->supervisor_remarks }}</textarea>
			</div>
		</div>
	</div>
