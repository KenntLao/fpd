...
@section('title', 'HRIS | Work Shift - Create')
@section('content_header')
<div class="row no-gutters">
	<div class="col-12 page-title">
		<h1><i class="fas fa-fw fa-columns"></i> Work Shift</h1>
	</div>
</div>
@stop
@section('content')
...
<div class="card">
	<div class="card-header">
		<h3 class="card-title">Create Work Shift</h3>
	</div>
	<div class="card-body">
		<form class="form-horizontal" method="post" action="/hris/pages/time/workshiftManagement" enctype="multipart/form-data" id="form">
