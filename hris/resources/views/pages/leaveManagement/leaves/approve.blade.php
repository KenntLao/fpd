...
@section('title', 'HRIS | Leave Management - Approve Leave Application')
...
<div class="card">
    ...
    <div class="card-body">
        <form class="form-horizontal" method="post" action="/hris/pages/leaveManagement/leaves/{{$leaves->id}}/approveSubmit" id="form">
            @method('PATCH')
            @csrf
            <div class="row">
    ...
    <div class="card-footer text-right">
        ...
        <button class="btn btn-success" type="submit" form="form"><i class="fa fa-check mr-1"></i> Approve</button>
    </div>
</div>
@stop
@section('css')
