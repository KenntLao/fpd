...
<div class="card">
	...
	<div class="card-body">
		<form class="form-horizontal" method="post" action="/hris/pages/training/myTraining/{{$employeeTrainingSession->id}}/update" enctype="multipart/form-data" id="form">
			@method('PATCH')
			@csrf
			<div class="row">
				...
				<div class="col-12 col-sm-6">
					<div class="form-group">
						...
						<div class="input">
							...
							<textarea class="form-control" name="feedback">{{$employeeTrainingSession->feedback}}</textarea>
						</div>
					</div>
				</div>
			</div>
