                ...
                <tbody>
                    @foreach($iteneraryRequests as $iteneraryRequest)
                        <td class="td-action">
                            <div class="row no-gutters">
                                <div class="col-md-6">
                                    <a class="btn btn-success btn-sm" href="/hris/pages/employees/iteneraryiteneraryRequests/{{$iteneraryRequest->id}}/edit"><i class="fas fa-edit"></i></a>
                                </div>
                                <div class="col-6">
                                    <!-- Button trigger modal -->
                                    <button class="btn btn-danger delete-btn btn-sm" type="button" data-toggle="modal" data-target="#modal-{{$iteneraryRequest->id}}" data-name="Itenerary request ID: {{$iteneraryRequest->id}}"><i class="fa fa-trash"></i></button>
                                </div>
                            </div>
                        </td>
                    </tr>
