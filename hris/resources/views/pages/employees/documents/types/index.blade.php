...
@section('title', 'HRIS | Document Management - Document Types')
@section('content_header')
<div class="row no-gutters">
	<div class="col-12 page-title">
		<h1><i class="fas fa-fw fa-file"></i> Document Types</h1>
	</div>
</div>
@stop
@section('content')
...
<div class="card">
	<div class="card-header">
		...
		@if(in_array('document-type-add', $_SESSION['sys_permissions']))
		<div class="card-tools">
			<a class="btn add-button btn-md" href="/hris/pages/employees/documents/types/create"><i class="fa fa-plus mr-1"></i> add document type</a>
		</div>
		@endif
	</div>
	<div class="card-body">
			...
			<table class="table table-hover table-bordered table-striped table-condensed">
				<thead>
					<tr>
						<th>name</th>
						<th>details</th>
						@if(in_array('document-type-edit', $_SESSION['sys_permissions']) OR in_array('document-type-delete', $_SESSION['sys_permissions']))
						<th>action</th>
						@endif
					</tr>
				</thead>
				<tbody>
					...
					<tr>
						...
						<td class="td-action">
							<div class="row no-gutters">
								@if(in_array('document-type-edit', $_SESSION['sys_permissions']))
								<div class="col-6">
									<a class="btn btn-success btn-sm" href="/hris/pages/employees/documents/types/{{$type->id}}/edit"><i class="fa fa-edit"></i></a>
								</div>
								@endif
								@if(in_array('document-type-delete', $_SESSION['sys_permissions']))
								<div class="col-6">
