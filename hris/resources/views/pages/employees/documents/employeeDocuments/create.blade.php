...
<div class="card">
	<div class="card-header">
		<h3 class="card-title">add employee document</h3>
	</div>
	<div class="card-body">
		<form class="form-horizontal" method="post" action="/hris/pages/employees/documents/employeeDocuments" enctype="multipart/form-data" id="form">
