...
<body class="hold-transition sidebar-mini layout-fixed">
		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="container-fluid">
                    ...
                    <form action="/submit-daily-collection-report-add" method="post">
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach($pcc_cash_on_hand_arr as $key => $bills) {
                                                        echo '<tr>';
                                                            ...
                                                            echo '<td class="p-0"><input type="text" min="0" class="form-control border-0 amount input-readonly" name="amount[]" readonly></td>';
    ...
    function compute_grand_total() {
        ...
        for(var i = 0; i < sub_total_count; i++) {
            ...
            sub_total = convertCurrency(sub_total) * 100;
            grand_total += sub_total;

            console.log(sub_total);
        }
        grand_total = grand_total / 100;
        $('.grand-total').val(convert_to_currency(grand_total.toFixed(2), "blur"));
