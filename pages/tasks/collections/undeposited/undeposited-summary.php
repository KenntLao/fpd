				...
				<div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo renderLang($undeposited_summary); ?></h3>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered">
                                    ...
                                    foreach($payment_types_arr as $key => $payment) {
                                        ...
                                        echo '</thead>';
                                        echo '<tbody>';
                                            $sql = $pdo->prepare("SELECT * FROM daily_collections dc JOIN daily_collections_payment_types dcpt ON (dc.id = dcpt.daily_collection_id) WHERE dc.temp_del = 0 AND dc.sub_property_id = :id AND dcpt.status = 0 AND dcpt.payment_type = :payment");
                                            $sql->bindParam(":id", $id);
                        ...
                        <div class="card-footer text-right">
                            <a href="/undeposited-summary-list" class="btn btn-default"><i class="fa fa-arrow-left"></i><?php echo renderLang($btn_back); ?></a>
                        </div>
                    </div>
