...
if(checkSession()) {
    ...
    $sql = $pdo->prepare("SELECT * FROM task_inspection_maintenance_fcu WHERE id = :id");
    $sql->bindParam(":id",$id);
    $sql->execute();
    if($sql->rowCount()) {
        ...
        $_SESSION['sys_fcu_inspection_err'] = renderLang($lang_no_data);
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control date" name="date" value="<?php echo $_data['date']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="model_no" value="<?php echo $_data['model_no']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="location_unit_no" value="<?php echo $_data['location_unit_no']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="serial_no" value="<?php echo $_data['serial_no']; ?>">
                                        </div>
                                    </div>
                             	...
                             	<div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control" name="time_started" value="<?php echo $_data['time_started']; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="time" class="form-control" name="time_finished" value="<?php echo $_data['time_finished']; ?>">
                                        </div>
                                    </div>
                                		...
                                		<div class="table-responsive">
                                			<table class="table table-bordered table-hover">
                                				...
                                				<tbody class="table-data">
                                					<?php 
                                                    $fcu_id_arr = array();
                                                    foreach ($fcu_monthly_inspection_arr as $fcu_key => $fcu_value) {

                                                        $sql = $pdo->prepare("SELECT * FROM task_inspection_maintenance_fcu_items WHERE fcu_id = :id AND scope_of_works = :key");
                                                        $sql->bindParam(":id",$id);
                                                        $sql->bindParam(":key",$fcu_key);
                                                        $sql->execute();
                                                        $data1 = $sql->fetch(PDO::FETCH_ASSOC);

                                                        $fcu_id_arr[] = $data1['scope_of_works'];

                                						echo '<tr>';

                                						echo '<td><p>'.renderLang($fcu_value).'</p><input type="hidden" name="scope_of_works[]" value="'.$fcu_key.'"></td>';
                                						echo '<td><textarea type="text" class="form-control border-0 notes" name="remarks[]">'.$data1['remarks'].'</textarea></td>';

                                						echo '</tr>';

                                					 }

                                                     $sql = $pdo->prepare("SELECT * FROM task_inspection_maintenance_fcu_items WHERE fcu_id = :id");
                                                     $sql->bindParam(":id",$id);
                                                     $sql->execute();
                                                     while ($data2 = $sql->fetch(PDO::FETCH_ASSOC)) {
                                                        if (!in_array($data2['scope_of_works'],$fcu_id_arr)) {

                                                            echo '<tr>';

                                                            echo '<td><textarea type="text" class="form-control border-0" name="scope_of_works[]">'.$data2['scope_of_works'].'</textarea></td>';
                                                            echo '<td><textarea type="text" class="form-control border-0 notes" name="remarks[]">'.$data2['remarks'].'</textarea></td>';
                                ...
                                <div class="row">
                                	...
                                	<div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <textarea type="text" class="form-control border-0 notes" name="recommendations"><?php echo $_data['recommendations']; ?></textarea>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                	...
                                	<div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control border-0" name="conducted_by" id="conducted_by" value="<?php echo $_data['conducted_by']; ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control border-0" name="acknowledged_by" id="acknowledged_by" value="<?php echo $_data['acknowledged_by']; ?>">
                                ...
                                <div class="row">
                                	...
                                	<div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control border-0" name="noted_by" id="noted_by" value="<?php echo $_data['noted_by']; ?>">
