                ...
                <div class="container-fluid" id="tabs">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4 mb-3">
                            <div class="bg-redd p-3 h-100 position-relative rounded" data-id="/inspection-types/0">
                                <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4 mb-3">
                            <div class="bg-redd p-3 h-100 position-relative rounded" data-id="/inspection-types/1">
                                <div class="row">
                                    <div class="col-8 position-relative">
                                        <div class="bottom-left">
                                            <h3>Maintenance</h3>
