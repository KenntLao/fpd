...
if(checkSession()) {
    ...
    $sql = $pdo->prepare("SELECT * FROM task_inspection_fire_extinguisher WHERE id = :id");
    $sql->bindParam(":id",$id);
    $sql->execute();
    if($sql->rowCount()) {
        ...
        $_SESSION['sys_fire_extinguisher_inspection_inspection_err'] = renderLang($lang_no_data);
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            ...
                                            foreach($months_arr as $key => $month) {
                                                echo '<option '.($_data['sub_property_id'] == $key ? 'selected' : '').' value="'.$key.'">'.renderLang($month).'</option>';
                                            }
                                            ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-readonly" name="year" id="year" readonly value="<?php echo $_data['year'] ; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            <label for="room_department"><?php echo renderLang($feic_room_department); ?></label>
                                                <input type="text" class="form-control" name="room_department" id="room_department" value="<?php echo $_data['room_department'] ; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            <label for="location_area"><?php echo renderLang($feic_location_area); ?></label>
                                                <input type="text" class="form-control" name="location_area" id="location_area" value="<?php echo $_data['location_area'] ; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            <label for="tagging"><?php echo renderLang($feic_tagging); ?></label>
                                                <input type="text" class="form-control" name="tagging" id="tagging" value="<?php echo $_data['tagging'] ; ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            <label for="type"><?php echo renderLang($feic_type); ?></label>
                                                <input type="text" class="form-control" name="type" id="type" value="<?php echo $_data['type'] ; ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                                ...
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($fire_extinguisher_inspection_checklist_arr as $fire_extinguisher_key => $fire_extinguisher) {
                                                            ...
                                                            $sql = $pdo->prepare("SELECT * FROM task_inspection_fire_extinguisher_checklist WHERE inspection_fe_id = :id AND item = :num");
                                                            $sql->bindParam(":id",$id);
                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            <label for="conducted_by"><?php echo renderLang($feic_inspection_conducted_by); ?></label>
                                            <input type="text" class="form-control input-readonly" name="conducted_by" value="<?php echo getFullName($_SESSION['sys_id'], $_SESSION['sys_account_mode']); ?>" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control date" value="<?php echo $_data['conducted_date'] ; ?>">
                                        </div>
                                    </div>
