                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="power_wirings" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="grounding_wire" required>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="form-group col-12">
                                        ...
                                        <textarea rows="2" class="form-control notes" name="remarks"></textarea>
                                    </div>
                                </div>
