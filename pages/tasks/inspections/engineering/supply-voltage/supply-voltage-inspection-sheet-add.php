                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="work_reference_no">
                                        </div>
                                    </div>
                                ...
                                <?php foreach($proper_installation_sheet_arr as $key => $inspections) { ?>
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td><input type="text" class="form-control border-0" name="l1-l2"></td>
                                                            <td><input type="text" class="form-control border-0" name="l2-l3"></td>
                                                            <td><input type="text" class="form-control border-0" name="l1-l3"></td>
                                                        </tr>
                                        ...
                                        <div class="col-lg-6 col-md-12">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-hover">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td><input type="text" class="form-control border-0" name="load_current_u"></td>
                                                            <td><input type="text" class="form-control border-0" name="load_current_v"></td>
                                                            <td><input type="text" class="form-control border-0" name="load_current_w"></td>
                                                        </tr>
                                                        <!-- <tr>
                                                            <td>
                                                                <select name="" id="" class="form-control border-0">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-12">
                                            ...
                                            <textarea name="" id="" rows="2" class="form-control notes" name="remarks"></textarea>
                                        </div>
                                    </div>
                                <?php } ?>
