                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            <label for=""><?php echo renderLang($inspection_sheet_date); ?></label>
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            <label for=""><?php echo renderLang($inspection_fcu_model_number); ?></label>
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            <label for=""><?php echo renderLang($inspection_unit); ?></label>
                                            <input type="text" class="form-control">
                                        </div>
                                    </div>
