		...
		<div class="content-wrapper">
			...
			<section class="content">
				...
				<div class="container-fluid">
                    ...
                    <form action="/submit-add-pcv-pre-operation-audit" method="post">

                        <input type="hidden" name="pcv_category" value="pre operations">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer text-right">
                                <a href="/pad-pcv-pre-operation-audit-list" class="btn btn-default"><i class="fa fa-arrow-left mr-1"></i><?php echo renderLang($btn_back); ?></a>
