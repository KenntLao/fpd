                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <?php if(checkPermission('pre-operation-audit-PAD-add')) { ?><a href="/add-pcv-pre-operation-audit" class="btn btn-danger btn-md"><i class="fa fa-plus pr-2"></i><?php echo renderLang($pre_operation_audit_add); ?></a><?php } ?>
                            </div>
                        </div>
                        <div class="card-body">
