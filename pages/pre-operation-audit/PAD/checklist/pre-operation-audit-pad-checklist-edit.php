...
<body class="hold-transition sidebar-mini layout-fixed">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="/submit-edit-pad-pre-operation-audit" method="post"  enctype="multipart/form-data">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer text-right">
                                ...
                                <button class="btn btn-success"><i class="fa fa-save mr-1"></i><?php echo renderLang($pre_operation_audit_pad_save_checklist); ?></button>
                            </div>
                        </div>
  ...
  <script>
    $(function(){
        ...
        $('body').on('click', '.add-row-ret-empty', function(e){
            e.preventDefault();

            var fields2 = '<tr>'+$(this).closest('table').find('.default-row-ret-empty').html()+'</tr>';
            $(this).closest('table').find('tbody').append(fields2);

        });

        // G. change save status 
