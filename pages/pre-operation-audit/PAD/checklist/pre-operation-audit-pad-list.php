                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="card-tools">
                                <?php if(checkPermission('pre-operation-audit-PAD-add')) { ?><a href="/add-pad-pre-operation-audit" class="btn btn-danger btn-md"><i class="fa fa-plus pr-2"></i><?php echo renderLang($pre_operation_audit_add); ?></a><?php } ?>
                            </div>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover">
                                    ...
                                    while($data = $sql->fetch(PDO::FETCH_ASSOC)) {
                                        ...
                                        echo '<td><a href="/pad-pre-operation-audit-checklist/'.$data['id'].'">['.$data['reference_number'].'] '.$data['project_name'].'</a></td>';
