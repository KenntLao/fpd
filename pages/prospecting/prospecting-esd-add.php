			...
			<section class="content-header">
				<div class="container-fluid">
					...
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>
								<i class="fas fa-binoculars mr-3"></i><?php echo renderLang($prospecting_new_leads); ?>
								<small><i class="fa fa-chevron-right ml-2 mr-2"></i></small>
								<span class="text-uppercase"><?php echo renderLang($prospecting_category_arr[1]); ?></span>
							</h1>
						</div>
					</div>
			...
			<section class="content">
				<div class="container-fluid">
					...
					<form method="post" action="/submit-add-prospecting">
						...
						<input type="hidden" name="prospecting_category" value="1">
						...
						<div class="card">
								...
								<div class="row">
									...
									<div class="col-lg-3 col-md-4">
										<div class="form-group">
											...
											<select class="form-control select2" id="property_category" name="property_category" <?php if(isset($_SESSION['sys_prospecting_add_property_category_val'])) { echo ' value="'.$_SESSION['sys_prospecting_add_property_category_val'].'"'; } ?> required>
                    							<?php 
                                ...
                                <div class="row">
									...
									<div class="col-lg-3 col-md-4">
										<div class="form-group">
											...
											<input type="text" class="form-control required<?php if($err) { echo ' is-invalid'; } ?>" id="contact_person" name="prospect_contact_person" placeholder="<?php echo renderLang($clients_contact_person_placeholder); ?>"<?php if(isset($_SESSION['sys_prospecting_add_contact_person_val'])) { echo ' value="'.$_SESSION['sys_prospecting_add_contact_person_val'].'"'; } ?> required>
										</div>
									</div>
									...
									<div class="col-lg-3 col-md-4">
										<div class="form-group">
											...
											<input type="text" class="form-control required<?php if($err) { echo ' is-invalid'; } ?>" id="designation" name="prospect_contact_designation" <?php if(isset($_SESSION['sys_prospecting_add_designation_val'])) { echo ' value="'.$_SESSION['sys_prospecting_add_designation_val'].'"'; } ?>>
										</div>
									</div>
									...
									<div class="col-lg-3 col-md-4">
										<div class="form-group">
											<label for="mobile_number"><?php echo renderLang($prospecting_contact_number); ?></label> <span><?php echo renderLang($prospecting_required); ?></span>
											<input type="text" class="form-control required<?php if($err) { echo ' is-invalid'; } ?>" id="mobile_number" name="prospect_contact_number" <?php if(isset($_SESSION['sys_prospecting_add_mobile_number_val'])) { echo ' value="'.$_SESSION['sys_prospecting_add_mobile_number_val'].'"'; } ?> required>
										</div>
									</div>
									...
									<div class="col-lg-3 col-md-4">
										<div class="form-group">
											...
											<input type="email" class="form-control required<?php if($err) { echo ' is-invalid'; } ?>" id="email_address" name="prospect_email_address" <?php if(isset($_SESSION['sys_prospecting_add_email_address_val'])) { echo ' value="'.$_SESSION['sys_prospecting_add_email_address_val'].'"'; } ?> >
										</div>
									</div>
							...
							<div class="card-footer text-right">
								<a href="/prospecting-list/1" class="btn btn-default mr-1"><i class="fa fa-arrow-left mr-2"></i><?php echo renderLang($btn_back); ?></a>
								<button class="btn btn-primary"><i class="fa fa-upload mr-2"></i><?php echo renderLang($prospecting_save_leads); ?></button>
							</div>
						</div><!-- card -->
					</form>
