...
<body class="hold-transition sidebar-mini layout-fixed">
					...
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>
								...
								<span class="text-uppercase"><?php echo renderLang($prospecting_category_arr[0]); ?></span>
							</h1>
						</div>
					</div>
			...
			<section class="content">
				<div class="container-fluid">
					...
					<form method="post" action="/submit-add-prospecting">
						...
						<input type="hidden" name="prospecting_category" value="0">
						...
						<div class="card">
								...
								<div class="row">
									...
									<div class="col-lg-3 col-md-4 others d-none">
										<div class="form-group">
											...
											<input type="text" min="0" class="form-control" id="property_category_others" name="property_category_others" placeholder="" >
										</div>
									</div>
												...
												<tbody class="table-data-contact">
                                                    <tr>
					                                    ...
					                                    <td>
															...
															<input type="text" class="form-control" name="prospect_contact_person" placeholder="<?php echo renderLang($clients_contact_person_placeholder); ?>" required>
														</td>

														<!-- DESIGNATION -->
														<td>
															<label><?php echo renderLang($prospecting_designation); ?></label>
															<input type="text" class="form-control" name="prospect_contact_designation">
														</td>
														...
														<td>
															...
															<input type="text" class="form-control" name="prospect_contact_number"  required>
														</td>

														<!-- EMAIL ADDRESS -->
														<td>
															<label><?php echo renderLang($prospecting_email_address); ?></label>
															<input type="email" class="form-control" name="prospect_email_address" >
														</td>
                                                    </tr>
                                                    
													<tr class="default-row-contact d-none">
					                                    ...
					                                    <td>
															...
															<input type="text" class="form-control" id="contact_person" name="contact_person[]" placeholder="<?php echo renderLang($clients_contact_person_placeholder); ?>">
														</td>
							...
							<div class="card-footer text-right">
								<a href="/prospecting-list/0" class="btn btn-default mr-1"><i class="fa fa-arrow-left mr-2"></i><?php echo renderLang($btn_back); ?></a>
	...
	<script>
		$(function() {
			 ...
			 $('.add-row-contact').on('click', function(e){
                e.preventDefault();

                var fields2 = '<tr>'+$('.default-row-contact').html()+'</tr>';
                $('.table-data-contact').append(fields2);
