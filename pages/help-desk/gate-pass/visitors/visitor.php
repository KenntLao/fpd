				...
				<div class="container-fluid">
						...
						<div class="card">
								...
								<div class="table-responsive">
                                	<table class="table table-bordered">
                                        ...
                                        <tr>
                                            ...
                                            <?php 
                                            if ($_data['purpose'] != 'Others') { 

                                            	 echo '<td>'.$_data['purpose'].'</td>';

                                            } else { 

                                           		echo '<td>'.$_data['purpose_others'].'</td>';
                                            } 
                                            ?>
							...
							<div class="card-footer text-right">
								...
								<a href="/edit-visitor/<?php echo $id; ?>" class="btn btn-primary"><i class="fa fa-pencil-alt mr-1"></i><?php echo renderLang($visitors_edit_visitor); ?></a>
								<?php } ?>
							</div>
						</div><!-- card -->
