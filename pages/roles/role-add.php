...
<head>
	...
	<title><?php echo renderLang($roles_add_role); ?> &middot; <?php echo $sitename; ?></title>
							...
							<div class="card-body">
								...
								<div class="row">
									...
									<div class="col-lg-3 col-md-4">
										<?php $err = isset($_SESSION['sys_roles_add_role_role_name_err']) ? 1 : 0; ?>
										<div class="form-group">
											...
											<input type="text" minlength="4" class="form-control required<?php if($err) { echo ' is-invalid'; } ?>" id="role_name" name="role_name" placeholder="<?php echo renderLang($roles_role_name_placeholder); ?>"<?php if(isset($_SESSION['sys_roles_add_role_role_name_val'])) { echo ' value="'.$_SESSION['sys_roles_add_role_role_name_val'].'"'; } ?> required>
											<?php if($err) { echo '<p class="error-message text-danger mt-1">'.$_SESSION['sys_roles_add_role_role_name_err'].'</p>'; unset($_SESSION['sys_roles_add_role_role_name_err']); } ?>
										</div>
									</div>
								...
								$err = isset($_SESSION['sys_roles_add_role_permissions_err']) ? 1 : 0;
								?>
								<div class="form-group">
									...
									<input type="text" id="permissions" class="required" name="permissions"<?php if(isset($_SESSION['sys_roles_add_role_permissions_val'])) { echo ' value="'.$_SESSION['sys_roles_add_role_permissions_val'].'"'; $permissions_val = $_SESSION['sys_roles_add_role_permissions_val']; } ?> required>
									<?php if($err) { echo '<p class="error-message text-danger mt-1">'.$_SESSION['sys_roles_add_role_permissions_err'].'</p>'; unset($_SESSION['sys_roles_add_role_permissions_err']); } ?>
								</div>
