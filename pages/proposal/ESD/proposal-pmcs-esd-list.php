		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1><i class="fas fa-handshake mr-3"></i><?php echo renderLang($property_management_consulting_services_esd); ?></h1>
						</div>
					</div>
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <?php if(checkPermission('proposal-esd-add')) { ?>
                                <a href="/esd-pmcs-add" class="btn btn-danger"><i class="fa fa-plus mr-1"></i><?php echo renderLang($property_management_consulting_services_esd_add); ?></a>
                            <?php } ?>
                            </div>
                        </div>
                        <div class="card-body">
