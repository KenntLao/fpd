...
if(checkSession()) {
    ...
    if(checkPermission('proposal-esd-add')) {
        ...
        $date_code = date('ymd');
        $sql = $pdo->prepare("SELECT id, reference_number FROM proposal_esd_tsa UNION SELECT id, reference_number FROM proposal_esd_generic ORDER BY id DESC LIMIT 1");
        $sql->execute();
        if($sql->rowCount()) {
        ...
        <head>
            ...
            <title><?php echo renderLang($generic_proposal_esd_edit); ?> &middot; <?php echo $sitename; ?></title>
            ...
            <div class="content-wrapper">
                ...
                <section class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h1><i class="fas fa-handshake mr-3"></i><?php echo renderLang($esd_technical_and_safety_audit_edit); ?></h1>
                            </div>
                        </div>
                ...
                <section class="content">
                    <div class="container-fluid">
                        ...
                        <form method="post" action="/submit-edit-esd-tsa-proposal">
                            <input type="hidden" name="id" value="<?= $_GET['id']?>" />
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title"><?php echo renderLang($esd_technical_and_safety_audit); ?></h3>
                                    <button type="button" class="btn float-right btn-<?= $proposal_esd_status_color_arr[$tsa['status']] ?>"><?= renderLang($proposal_esd_status_arr[$tsa['status']]) ?></button>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" id="proposalStatus" name="status" required>
                                                    ...
                                                    foreach ($proposal_esd_status_arr as $esdNum => $esdStatus) {
                                                        if ($esdNum == $tsa['status']) $active = 'selected=selected'; else $active = '';
                                                        ?>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select2" id="projectName" name="prospect_id" required>
                                                    ...
                                                    while($data = $sql->fetch(PDO::FETCH_ASSOC)) {
                                                        if ($tsa['prospect_id']==$data['id']) $active = 'selected'; else $active = '';
                                        ...
                                        <div class="col-3">
                                            ...
                                            <input type="text" class="form-control" id="referenceNo" name="reference_number" value="<?= $tsa['reference_number']; ?>" readonly>
                                        </div>
                                        <div class="col-3">
                                            <label>Date</label>
                                            <input type="text" class="form-control date" id="longDate" name="date" value="<?= $tsa['date'] ?>" required/>
                                        </div>
                                        <div class="col-12">
                                            <div class="row">
                                                <div class="col-3 pt-3">
                                                    <label>Company/Client Name</label>
                                                    <input type="text" class="form-control mb-1" id="clientName" name="clientName" placeholder="Client Name" value="<?= $tsa['clientName'] ?>" required/>
                                                    <br />
                                                    <label>Address</label>
                                                    <input type="text" class="form-control mb-1" id="addressLine1" name="address_line1" placeholder="Line 1" value="<?= $tsa['address_line1'] ?>" required/>
                                                    <input type="text" class="form-control mb-1" id="addressLine2" name="address_line2" placeholder="Line 2" value="<?= $tsa['address_line2'] ?>" required/>
                                                    <br />
                                                    <label>Payment Terms</label>
                                                    <textarea class="form-control" placeholder="Payment Terms" id="paymentTerms" name="payment_terms" value="<?= $tsa['payment_terms'] ?>" required></textarea>
                                                    <br />
                                                    <label>Proposal Validity</label>
                                                    <textarea class="form-control" placeholder="Proposal Validity" id="proposalValidity" name="validity_period" <?= $tsa['validity_period'] ?> required></textarea>
                                                    <br />
                                                    <label>Signatory</label>
                                                    <input type="text" class="form-control mb-1" id="signatoryName" name="signatoryName" placeholder="Name" value="<?= $tsa['signatoryName'] ?>" required/>
                                                    <input type="text" class="form-control mb-1" id="signatoryPosition" name="signatoryPosition" placeholder="Position" value="<?= $tsa['signatoryPosition'] ?>" required/>
                                                    <input type="text" class="form-control mb-1" id="signatoryDepartment" name="signatoryDepartment" placeholder="Department" value="<?= $tsa['signatoryDepartment'] ?>" required/>
                                                    <br />
                                                    <label>Conforme</label>
                                                    <input type="text" class="form-control mb-1" id="conformeSignatoryName" placeholder="Name" value="<?= $tsa['conformeSignatoryName'] ?>" required/>
                                                    <input type="text" class="form-control mb-1" id="conformeSignatoryContact" placeholder="Contact" value="<?= $tsa['conformeSignatoryContact'] ?>" required/>
                                                    <br />
                                                    <label>Letter Subject</label>
                                                    <input type="text" class="form-control mb-1" id="letterSubject" name="letter_subject" placeholder="Letter Subject" <?= $tsa['letter_subject'] ?> required/>
                                                    <br />
                                                            ...
                                                            <div class="col-12 p-5" style="box-shadow: 0 0 2px gray; min-height: 14in">
                                                                <div class="row" style="font-family: Calibri; font-size: 14pt">
                                                                    <div class="col-10">
                                                                        ...
                                                                        <br /><br />
                                                                        <span class="bg-gray-light pl-2 pr-2 longDatePreview" data-toggle="tooltip" data-placement="top" title="Long Date"><?= is_null($tsa['date']) || $tsa['date'] == "" ? "[Long Date]" : date("d F Y", strtotime($tsa['date'])) ?></span>
                                                                        <br /><br /><br />
                                                                        <span class="bg-gray-light pl-2 pr-2" id="clientNamePreview" data-toggle="tooltip" data-placement="top" title="Company/Client Name"><?= is_null($tsa['clientName']) || $tsa['clientName'] == "" ? "[Company/Client Name]" : $tsa['clientName'] ?></span><br />
                                                                        <span class="bg-gray-light pl-2 pr-2" id="addressLine1Preview" data-toggle="tooltip" data-placement="top" title="Address Line 1"><?= is_null($tsa['address_line1']) || $tsa['address_line1'] == "" ? "[Address Line 1]" : $tsa['address_line1'] ?></span><br />
                                                                        <span class="bg-gray-light pl-2 pr-2" id="addressLine2Preview" data-toggle="tooltip" data-placement="top" title="Address Line 2"><?= is_null($tsa['address_line2']) || $tsa['address_line2'] == "" ? "[Address Line 2]" : $tsa['address_line2'] ?></span><br /><br /><br />
                                                                    </div>
                                                                    ...
                                                                    <div class="col-12">
                                                                        ...
                                                                        <p class="text-justify">Our fee for the said service is <span class="bg-gray-light pl-2 pr-2" id="paymentTermsPreview" data-toggle="tooltip" data-placement="top" title="Payment Terms"><?= is_null($tsa['payment_terms']) || $tsa['payment_terms'] == "" ? "[Payment Terms]" : $tsa['payment_terms'] ?></span> inclusive of VAT. Our offered terms of payment is full payment upon completion of works.  The proposal shall be valid for <span class="bg-gray-light pl-2 pr-2" id="proposalValidityPreview" data-toggle="tooltip" data-placement="top" title="Proposal Validity"><?= is_null($tsa['validity_period']) || $tsa['validity_period'] == "" ? "[Proposal Validity]" : $tsa['validity_period'] ?></span>.</p>
                                                                    ...
                                                                    <div class="col-6">
                                                                        <p>
                                                                            <span class="bg-gray-light pl-2 pr-2 signatoryNamePreview" data-toggle="tooltip" data-placement="top" title="Signatory Name"><?= is_null($tsa['signatoryName']) || $tsa['signatoryName'] == "" ? "[Signatory Name]" : $tsa['signatoryName'] ?></span><br />
                                                                            <span class="bg-gray-light pl-2 pr-2 signatoryPositionPreview" data-toggle="tooltip" data-placement="top" title="Signatory Position"><?= is_null($tsa['signatoryPosition']) || $tsa['signatoryPosition'] == "" ? "[Signatory Position]" : $tsa['signatoryPosition'] ?></span><br />
                                                                            <span class="bg-gray-light pl-2 pr-2 signatoryDepartmentPreview" data-toggle="tooltip" data-placement="top" title="Signatory Department"><?= is_null($tsa['signatoryDepartment']) || $tsa['signatoryDepartment'] == "" ? "[Signatory Department]" : $tsa['signatoryDepartment'] ?></span>
                                                                        </p>
                                                                        <br /><br />
                                                                    </div>
                                                                    <div class="col-6">
                                                                    ...
                                                                    <div class="col-6">
                                                                        <p>
                                                                            <span class="bg-gray-light pl-2 pr-2" id="conformeSignatoryNamePreview" data-toggle="tooltip" data-placement="top" title="Conforme Signatory Name"><?= is_null($tsa['conformeSignatoryName']) || $tsa['conformeSignatoryName'] == "" ? "[Conforme Signatory Name]" : $tsa['conformeSignatoryName'] ?></span><br />
                                                                            Contact: <span class="bg-gray-light pl-2 pr-2" id="conformeSignatoryContactPreview" data-toggle="tooltip" data-placement="top" title="Conforme Signatory Contact"><?= is_null($tsa['conformeSignatoryContact']) || $tsa['conformeSignatoryContact'] == "" ? "[Conforme Signatory Contact]" : $tsa['conformeSignatoryContact'] ?></span>
                                                                        </p>
                                                                    </div>
                                                                    <div class="col-6">
                                                                    </div>
                                                            ...
                                                            <div class="col-12 p-5" style="box-shadow: 0 0 2px gray; min-height: 14in">
                                                                <div class="row" style="font-family: Calibri; font-size: 14pt">
                                                                    <div class="col-10">
                                                                        ...
                                                                        <span class="bg-gray-light pl-2 pr-2 longDatePreview" data-toggle="tooltip" data-placement="top" title="Long Date"><?= is_null($tsa['date']) || $tsa['date'] == "" ? "[Long Date]" : date("d F Y", strtotime($tsa['date'])) ?></span>
                                                                        <br /><br /><br />
                                                                        Subject: <span class="bg-gray-light pl-2 pr-2" id="letterSubjectPreview" data-toggle="tooltip" data-placement="top" title="Letter Subject"><?= is_null($tsa['letter_subject']) || $tsa['letter_subject'] == "" ? "[Letter Subject]" : $tsa['letter_subject'] ?></span><br /><br /><br />
                                                                    </div>
                                                                    <div class="col-2 text-right">
                                                                        <img src="/assets/images/Company%20Logo.png" style="width: 100%"/>
                                                                    </div>
                                                                    <div class="col-12 objectives">
                                                                        ...
                                                                        <?php
                                                                            $tsaOq = $pdo->query("SELECT * FROM proposal_esd_tsa_objectives WHERE proposal_id = ".$tsa['id']);
                                                                            $tsaO = $tsaOq->fetchAll(PDO::FETCH_ASSOC);
                                                                        ?>
                                                                        <div id="objectives">
                                                                            <?php if ($tsaOq->rowCount()==0) { ?>
                                                                            ...
                                                                            <?php }?>
                                                                            <?php if ($tsaOq->rowCount()>0) foreach ($tsaO as $objective) {?>
                                                                            <div class="input-group pl-5 objective" style="position: relative; top: -5px;">
                                                                                <div class="input-group-prepend" style="position: relative; top: 5px;">
                                                                                    <span class="objectiveCtr"><?= $objective['number']?></span>.
                                                                                </div>
                                                                                <textarea type="text" class="form-control-plaintext" name="objective[]" placeholder="Objective" style="padding-left: 5px;" required><?= $objective['objective'] ?></textarea>
                                                                                <div class="input-group-append">
                                                                                    <button class="btn bg-none btnDeleteObjective" type="button">
                                                                                        <i class="fa fa-trash-alt text-gray"></i>
                                                                                    </button>
                                                                    ...
                                                                    <div class="col-12">
                                                                        ...
                                                                        <br />
                                                                        <?php $tsaScopeQ = $pdo->query('SELECT * FROM proposal_esd_tsa_scopes WHERE proposal_id = '.$tsa['id']); ?>
                                                                        <div class="scopeOfWorks">
                                                                            <?php if ($tsaScopeQ->rowCount()==0) { ?>
                                                                            ...
                                                                            <?php } ?>
                                                                            <?php
                                                                                if ($tsaScopeQ->rowCount()>0) {
                                                                                    $tsaScopes = $tsaScopeQ->fetchAll(PDO::FETCH_ASSOC);
                                                                                    $tsaScopeCtr = 0;
                                                                                    foreach ($tsaScopes as $tsaScope) {
                                                                                        ?>
                                                                                        <div
                                                                                            class="row scopeOfWork pb-3">
                                                                                            <div class="col-12">
                                                                                                <div class="row">
                                                                                                    <div
                                                                                                        class="col-12 input-group scopeOfWorkName pb-3">
                                                                                                        <div
                                                                                                        ...
                                                                                                        <input
                                                                                                            type="text"
                                                                                                            class="form-control"
                                                                                                            name="scope[<?= $tsaScopeCtr ?>][scope]"
                                                                                                            placeholder="Scope of Work Name"
                                                                                                            value="<?= $tsaScope['scope'] ?>"
                                                                                                            required/>
                                                                                                        <div
                                                                                                            class="input-group-append">
                                                                                                            <button
                                                                                                                class="btn bg-gray-light btnDeleteScope"
                                                                                                                type="button">
                                                                                                                <i class="fa fa-trash-alt text-gray"></i>
                                                                                                            </button>
                                                                                                        </div>
                                                                                                    ...
                                                                                                    <div
                                                                                                        class="col-12 pl-5 tasks">
                                                                                                        <?php
                                                                                                        $tsaTaskQ = $pdo->query("SELECT * FROM proposal_esd_tsa_tasks WHERE scope_id = " . $tsaScope['id']);
                                                                                                        $tsaTasks = $tsaTaskQ->fetchAll(PDO::FETCH_ASSOC);
                                                                                                        $tsaTaskCtr = 0;
                                                                                                        ?>
                                                                                                        <?php if ($tsaTaskQ->rowCount() == 0) { ?>
                                                                                                            <div
                                                                                                                class="input-group task pb-3">
                                                                                                                <div
                                                                                                                    class="input-group-prepend">
                                                                                                                    <span
                                                                                                                        class="input-group-text taskCtr">1</span>
                                                                                                                </div>
                                                                                                                <input
                                                                                                                    type="text"
                                                                                                                    class="form-control"
                                                                                                                    name="scope[<?= $tsaScopeCtr ?>][scope][task][0]"
                                                                                                                    placeholder="Task Name"
                                                                                                                    required/>
                                                                                                                <div
                                                                                                                    class="input-group-append">
                                                                                                                    <button
                                                                                                                        class="btn bg-gray-light btnDeleteTask"
                                                                                                                        type="button">
                                                                                                                        <i class="fa fa-trash-alt text-gray"></i>
                                                                                                                    </button>
                                                                                                                </div>
                                                                                                        ...
                                                                                                        <?php } ?>
                                                                                                        <?php
                                                                                                        if ($tsaTaskQ->rowCount() > 0) {
                                                                                                            foreach ($tsaTasks as $tsaTask) {
                                                                                                                ?>
                                                                                                                <div
                                                                                                                    class="input-group task pb-3">
                                                                                                                    <div
                                                                                                                        class="input-group-prepend">
                                                                                                                        <span
                                                                                                                            class="input-group-text taskCtr"><?= $tsaTaskCtr + 1 ?></span>
                                                                                                                    </div>
                                                                                                                    <input
                                                                                                                        type="text"
                                                                                                                        class="form-control"
                                                                                                                        name="scope[<?= $tsaScopeCtr ?>][scope][task][<?= $tsaTaskCtr ?>]"
                                                                                                                        placeholder="Task Name"
                                                                                                                        value="<?= $tsaTask['task'] ?>"
                                                                                                                        required/>
                                                                                                                    <div
                                                                                                        ...
                                                                                                        <button
                                                                                                            class="btn btn-block bg-gray-light text-gray btnAddNewTask"
                                                                                                            type="button">
                                                                                                            Add New Task
                                                                                                        </button>
                                                                                                    </div>
