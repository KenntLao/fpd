...
<head>
	...
	<title><?php echo renderLang($labor_cost_outsource_edit); ?> &middot; <?php echo $sitename; ?></title>
			...
			<section class="content-header">
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-sm-9">
							<h1>
                                <i class="fas fa-handshake mr-3"></i><?php echo renderLang($labor_cost_outsource_edit); ?>
                                <small class="fa fa-chevron-right ml-2 mr-2"></small>
                                <?php echo getField('project_name', 'prospecting', 'id = '.$_data['prospect_id']); ?>
                                <small class="ml-2"><?php echo renderLang($labor_cost_version).' '.$_data['version']; ?></small>
                            </h1>
						</div>
					</div>
					...
					<form action="/submit-edit-outsource-labor-cost" method="post">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"><?php echo renderLang($labor_cost_outsource_edit_form); ?></h3>
                            </div>
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        ...
                                        <input type="number" class="form-control" name="personnel_night_shift" id="personnel_night_shift" value="<?php echo $_data['night_shift_personnel']; ?>">
                                    </div>
                            ...
                            <div class="card-footer text-right">
                                ...
                                <?php if($_data['status'] == 0) { ?>
                                    <button class="btn btn-success"><i class="fa fa-save mr-1"></i><?php echo renderLang($labor_cost_outsource_edit); ?></button>
                                <?php } ?>
                            </div>
                        </div>
            ...
            $('body').on('click', '.remove-row', function(e){
                ...
                if($(this).closest('tbody').children('tr').length != 1) {
                    if(confirm("Are you sure to permanently delete this row?")) {
                        var id = $(this).closest('tr').find('[name="labor_cost_id[]"]').val();
                        
                        $.post("/delete-labor-cost-outsource-row", {
                            id:id
                        }, function(data) {
                            switch(data) {
                                case "success":
