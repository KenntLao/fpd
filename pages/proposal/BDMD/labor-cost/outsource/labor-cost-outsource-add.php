...
<head>
	...
	<title><?php echo renderLang($labor_cost_outsource_add); ?> &middot; <?php echo $sitename; ?></title>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-sm-9">
							<h1><i class="fas fa-handshake mr-3"></i><?php echo renderLang($labor_cost_outsource_add); ?></h1>
						</div>
					</div>
					...
					<form action="/submit-add-outsource-labor-cost" method="post">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"><?php echo renderLang($labor_cost_outsource_add_form); ?></h3>
                            </div>
                            <div class="card-body">
                                            ...
                                            <table class="table table-bordered">
                                                ...
                                                <tbody>
                                                    <tr class="default-row">
                                                        ...
                                                        <td><input type="text" class="form-control border-0 insurance input-readonly" name="" readonly value="₱100.00"></td>
                            ...
                            <div class="card-footer text-right">
                                ...
                                <button class="btn btn-primary"><i class="fa fa-upload mr-1"></i><?php echo renderLang($labor_cost_outsource_add); ?></button>
                            </div>
                        </div>
