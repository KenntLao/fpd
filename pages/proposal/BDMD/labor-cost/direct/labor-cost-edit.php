		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="container-fluid">
					...
					<form action="/submit-edit-labor-cost" method="post">

						<div class="card">
							<div class="card-header">
								<h3 class="card-title"><?php echo renderLang($proposals_labor_cost_form); ?></h3>
                                <div class="card-tools">
                                    <button type="button" class="btn btn-<?php echo $labor_cost_status_color_arr[$_data['status']]; ?>"><?php echo renderLang($labor_cost_status_arr[$_data['status']]); ?></button>
                                </div>
							</div>
							<div class="card-body">
							...
							<div class="card-footer text-right">
                                ...
                                <?php if($_data['status'] == 0) { ?>
								<button class="btn btn-success"><i class="fa fa-save mr-1"></i><?php echo renderLang($labor_cost_update); ?></button>
                                <?php } ?>
							</div>
						</div>
