...
<head>
	...
	<title><?php echo renderLang($add_proposal_pod); ?> &middot; <?php echo $sitename; ?></title>
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<div class="container-fluid">
					...
					<div class="row">
						<div class="col-sm-9">
							<h1><i class="fas fa-handshake mr-3"></i><?php echo renderLang($add_proposal_pod); ?></h1>
						</div>
					</div>
			...
			<section class="content">
				<div class="container-fluid">
                    <form action="/submit-add-pod-introductory-letter-proposal" method="post">

                        <input type="hidden" name="proposal_category" value="pod">
                        ...
                        <div class="card">
                            ...
                            <div class="card-footer text-right">
                                <a href="/pod-proposal-types" class="btn btn-default"><i class="fa fa-arrow-left mr-1"></i><?php echo renderLang($btn_back); ?></a>
