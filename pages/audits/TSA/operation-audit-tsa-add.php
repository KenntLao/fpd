                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="prospect_id" id="prospect_id" class="form-control select2">
                                                <option></option>
                                                <?php 
                                                $sql = $pdo->prepare("SELECT n.prospect_id, reference_number, project_name FROM nni n  LEFT JOIN prospecting p ON (n.prospect_id = p.id) WHERE n.temp_del = 0 AND n.status != 0");
                                                $sql->execute();
                                                while($data = $sql->fetch(PDO::FETCH_ASSOC)) {
                                                    echo '<option value="'.$data['prospect_id'].'">['.$data['reference_number'].'] '.$data['project_name'].'</option>';
                                                }
                                                ?>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-lg-3 col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control date-range" name="date_of_audit" id="date_of_audit">
                                        </div>
                                    </div>  
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="card-body pad">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <textarea name="summary" id="summary" rows="2" class="form-control notes"></textarea>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <!-- <div class="row my-5">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <div class="table-responsive">
                                                                    <table class="table table-bordered table-hover" id="picture_prior">
                                                                        <thead class="text-center bg-dark">
                                                                            <tr>
                                                                        ...
                                                                        foreach ($tsa_audit_prioritization_arr as $key => $prioritization){ 
                                                                            echo '<tbody>';
                                                                                echo '<tr>';
                                                                                    echo '<td colspan="4" class="bg-gray" data-toggle="toggle">';
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body pad">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <textarea name="building_description" id="building_description" rows="10" class="form-control notes"></textarea>
                                                            </div>
                                                        </div>

                                                        <div class="col-12">
                                                            <div class="text-center" id="building_picture">
                                                                <img src="" class="img-fluid mb-2 mr-2 img-thumbnail img-responsive" alt="white sample"/>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-bordered table-hover">
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td colspan="4">Non-conforming items during the year <input type="text" name="nc_years" class="ml-1 mr-1 text-center border-top-0 border-left-0 border-right-0"></td>
                                                                            </tr>
                                                                            <tr>
                                                                ...
                                                                <?php foreach ($operation_safety_inspection_checklist_arr as $key => $value) { 
                                                                    ...
                                                                    echo '</tr>';
                                                                        ...
                                                                        echo '<td class="check" data-val="ns">';
                                                                            echo '<button class="btn btn-danger d-none"><i class="fa fa-check"></i></button>';
                                                                        echo '</td>';
                                                                        echo '<td class="d-none"><input type="hidden" name="sic_check_status[]" class="check_value" value=""></td>';
                                                                        echo '<td><input type="text" class="form-control border-0" name="sic_remarks[]"></td>';
                                                                        echo '</tr>';
                                        ...
                                        <div class="collapse" id="tab-permits">
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="table table-bordered table-hover" id="permit">
                                                            <thead>
                                                                <tr>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                while($_data = $sql->fetch(PDO::FETCH_ASSOC)) {
                                                                    echo '<tr>';
                                                                        ...
                                                                        echo '<td><input type="text" name="permit_status[]" class="form-control border-0"></td>';
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-bordered table-hover" id="as_built_plan">
                                                                        <thead>
                                                                            <tr>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                ...
                                                                <div class="table-responsive">
                                                                    <table class="table table-bordered table-hover" id="equipment_manuals">
                                                                        <thead>
                                                                            <tr>
