...
<head>
    ...
    <title><?php echo renderLang($operation_audit_tsa_edit_page); ?> &middot; <?php echo $sitename; ?></title>
...
<body class="hold-transition sidebar-mini layout-fixed">
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <div class="container-fluid">
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1><i class="fas fa-clipboard-check mr-3"></i><?php echo renderLang($operation_audit_tsa_update); ?>
            ...
            <section class="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="/submit-edit-tsa-operations-audit" method="post" enctype="multipart/form-data">

                        <input type="hidden" name="tsa_id" value="<?php echo $id; ?>">

                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title"><?php echo renderLang($operation_audit_tsa_edit_page); ?></h3>
                                <div class="card-tools">
                                    <?php if(checkPermission('operations-audit-TSA-delete')) { ?><a href="" id="delete" class="btn btn-danger btn-md"><i class="fa fa-trash mr-1"></i><?php echo renderLang($operation_audit_tsa_delete); ?></a><?php } ?>
                                </div>
                            </div>
                            <div class="card-body">
                                                                        ...
                                                                        foreach ($tsa_audit_prioritization_arr as $key => $prioritization) {
                                                                            ...
                                                                            if (renderlang($prioritization) != 'Others') {
                                                                                ...
                                                                                echo '<tbody class="hide">';
                                                                                    ...
                                                                                    // PERMIT
                                                                                        $sql2 = $pdo->prepare("SELECT recommendation, findings, prioritization_specify, prioritization FROM operations_audit_tsa_permit_licences WHERE prioritization = :prioritization AND tsa_id = :tsa_id");
                                                                    ...
                                                                    <table class="table table-bordered table-hover">
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            if ($sql->rowCount()) {
                                                                                ...
                                                                                echo '<tr>';
                                                                                    echo '<td colspan="4">Non-conforming items during the year <input type="text" name="nc_years[]" class="ml-1 mr-1 text-center border-top-0 border-left-0 border-right-0"></td>';
                                                                                echo '</tr>';
                                                                                echo '<tr>';
                                ...
                                <?php if(checkPermission('operations-audit-TSA-comments')) { ?>
                                <!-- comment box -->
                                    <?php 
                                    $sql = $pdo->prepare("SELECT * FROM comments WHERE module = 'operations-audit-TSA' AND module_type = 'approval' AND module_id = :id AND temp_del = 0 ORDER BY comment_date DESC");
                                    $sql->bindParam(":id", $id);
                                    $sql->execute();
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <div class="card direct-chat direct-chat-primary">
                                                ...
                                                <div class="card-footer">
                                                    <?php if(checkPermission('operations-audit-TSA-comment-add')) { ?>
                                ...
                                <?php if(checkPermission('operations-audit-TSA-approve')) { ?>
                                <div class="row">
                                    <div class="col-lg-6">
                                ...
                                <?php if(checkPermission('operations-audit-TSA-edit') && $_data['status'] != 3 && $_data['status'] != 1) { ?>
                                <div class="row mt-5">
                            ...
                            <div class="card-footer text-right">
                                ...
                                <?php if(checkPermission('operations-audit-TSA-edit') && $_data['status'] != 3 && $_data['status'] != 1) { ?>
                                <button class="btn btn-success" id="submit-btn"><i class="fa fa-save mr-1"></i><?php echo renderLang($operation_audit_tsa_update); ?></button>
                                <?php } ?>
                            </div>
                        </div>
        ...
        <!-- confirm delete -->
        <?php if(checkPermission('operations-audit-TSA-delete')){ ?>
        <div class="modal fade" id="modal-confirm-delete">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="/delete-operations-audit-tsa" method="post" class="ajax-form">
                        <input type="hidden" name="id" value="<?php echo $id; ?>">
                        <div class="modal-body">
                            <p><?php echo renderLang($operation_audit_tsa_modal_delete_msg1); ?></p>
                            <p><?php echo renderLang($operation_audit_tsa_modal_delete_msg2); ?></p>
                            <hr>
    ...
    <script>
        $(function(){
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        if(response_arr[0] == 1) { // val is 1
                            window.location.href = '/operations-audit-tsa-list';
                        } else {
                            $('.modal-error')
            ...
            $('#property_id').on('change', function(){
                ...
                $.post('/render-tsa-audit', {
                   ...
                   var result = JSON.parse(data); 
                    ...
                    $('#summary_section_1').html(result['summary']);
            ...
            $('body').on('click', '.add-row-sec1', function(e){
                ...
                var field = '<tr>'+$(this).closest('tfoot').find('tfoot').find('tr:nth-child(1)').html();
            ...
            $('body').on('click', '.add-row-pictures', function(e){
                ...
                $(this).closest('.table-responsive').find('tfoot').append(fields);
                ...
                $.post('/operations-audit-approve', {
                    ...
                    if(data == 'success') {
                        ...
                        switch(data) {
                            ...
                            case 'error':
                                window.location.href= "/operations-audit-checklist/"+audit_id;
                            break;
                        }
                    }
                });
            ...
            $('#add-comment').on('click', function(e){
                ...
                var module = 'operations-audit-TSA';
            ...
            $('body').on('click', '.remove-row', function(e){
                ...
                if($(this).closest('tbody').children('tr').length != 1) {
                    if(confirm("Are you sure to permanently delete this row?")) {
                        ...
                        $.post("/delete-tsa-operations-audit-row", {
                            id:id,
                            category:category
                        }, function(data) {
                            switch(data) {
