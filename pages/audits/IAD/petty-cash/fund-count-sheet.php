...
<head>
	...
	<title><?php echo renderLang($petty_cash_fund_count_sheet); ?> &middot; <?php echo $sitename; ?></title>
			...
			<section class="content-header">
				<div class="container-fluid">
					...
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1>
                                <i class="fas fa-clipboard-check mr-3"></i><?php echo renderLang($petty_cash_fund_count_sheet); ?>
				...
				<div class="container-fluid">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><?php echo renderLang($petty_cash_fund_count_sheet); ?></h3>
                        ...
                        <div class="card-body">
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table class="table">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="text" data-type="currency" min="0" class="form-control" name="total_per_books" id="total_per_book" value="<?php echo $data['total_per_book']; ?>">
                                                </td>
                                            </tr>
                                            <tr>
                                                <th class="text-uppercase"><?php echo renderLang($pre_operation_audit_pcc_total_per_count); ?></th>
                            ...
                            <!-- comment box -->
                                <div class="row mt-5">
                                    ...
                                    <div class="col-lg-6">
                                        <?php renderComments($id, "IAD-fund-count-sheet", "approval", "operation-audit-IAD-comment-add", renderLang($lang_comments)); ?>
                                    </div>
                                </div>
                            <?php } ?>
    ...
    $(function(){
        ...
        // add comment
            $('#add-comment').on('click', function(e){
                ...
                var module = 'IAD-fund-count-sheet';
        ...
        if(isset($_SESSION['sys_fund_count_sheet_approval_suc'])) {
            ?>
            Toast.fire({
                type: 'success',
                title: '<?php echo $_SESSION['sys_fund_count_sheet_approval_suc']; ?>'
            });
            <?php
            unset($_SESSION['sys_fund_count_sheet_approval_suc']);
        }
        ?>
        ...
        $('body').on('click', '.btn-approval', function(e){
            ...
            $.post('/update-fund-count-sheet-status', {
                id:id, status:status
            }, function(data){
