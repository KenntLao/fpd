					...
					<div class="card">
						<div class="card-header">
                            ...
                            <div class="card-tools">
								<?php if(checkPermission('contract-add')) { ?><a href="/add-contract" class="btn btn-danger btn-md"><i class="fa fa-plus pr-2"></i><?php echo renderLang($contract_new_contract); ?></a><?php } ?>
							</div>
                        </div>
                        <div class="card-body">
									...
									<tbody>
										...
										while($data = $sql->fetch(PDO::FETCH_ASSOC)) {
											...
											echo '<tr>';
												...
												// PROJECT ID
												echo '<td><a href="/contract/'.$data['id'].'">['.$data['reference_number'].'] '.$data['project_name'].'</a></td>';
												...
												if(checkPermission('contract-edit')) { 
													...
													echo '<td><a href="/edit-contract/'.$data['id'].'" class="btn btn-success btn-xs" title="'.renderLang($contract_edit_contract).'"><i class="fa fa-pencil-alt"></i></a></td>';
												}
