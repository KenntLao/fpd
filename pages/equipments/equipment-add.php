		...
		<div class="content-wrapper">
			...
			<section class="content">
				<div class="container-fluid">
                    ...
                    <?php 
                    renderError('sys_equipment_add_err');
                    renderSuccess('sys_equipment_add_suc');
                    ?>

                    <form action="/submit-add-equipment" method="post">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-3">
                                        <div class="form-group">
                                            <label for="building_id"><?php echo renderLang($equipments_building); ?></label>
                                    ...
                                    <div class="col-md-4 col-lg-3">
                                        <div class="form-group">
                                            <label for="serial_number"><?php echo renderLang($equipments_serial_number); ?></label>
                                    ...
                                    <div class="col-md-4 col-lg-3">
                                        <div class="form-group">
                                            <label for="description"><?php echo renderLang($equipments_description); ?></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4 col-lg-3">
                                        <div class="form-group">
                                            <label for="date"><?php echo renderLang($equipments_date_acquired); ?></label>
                                    ...
                                    <div class="col-md-4 col-lg-3">
                                        <div class="form-group">
                                            <label for="amount"><?php echo renderLang($equipments_amount); ?></label>
                                    ...
                                    <div class="col-md-4 col-lg-3">
                                        <div class="form-group">
                                            <label for="supplier"><?php echo renderLang($equipments_supplier); ?></label>
